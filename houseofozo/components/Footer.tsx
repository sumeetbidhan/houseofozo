      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            {/* Newsletter integrated below Collections */}
            <div className="mt-5 -ml-2">
              <h2 className="text-lg font-subheading text-gray-900 mb-3">Stay Connected</h2>
              
              <div className="flex gap-1">
                <input
                  type="email"
                  placeholder="Email"
                  className="flex-1 px-3 py-2 rounded border border-gray-300 focus:ring-2 focus:ring-purple-400 focus:border-purple-400 focus:outline-none transition-all duration-200 text-sm"
                />
                <Button className="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 text-sm whitespace-nowrap">
                  Subscribe
                </Button>
              </div>
              <p className="font-body text-gray-600 text-xs mt-2">Subscribe to the newsletter</p>
            </div>
          </div>
